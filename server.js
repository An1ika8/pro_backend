...
// app.get("/user_profile", verifyToken, (req, res) => {
...
// app.put("/user_profile", verifyToken, (req, res) => {
//     const userId = req.user.user_id;
...
//                 db.query(
//                     "UPDATE project_detailss SET owner = ? WHERE owner = (SELECT username FROM users WHERE user_id = ?)",
